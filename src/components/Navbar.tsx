...
export const Navbar: React.FC<NavbarProps> = ({ currentPath, navigate }) => {
  ...
  return (
    <header className="sticky top-0 z-40 bg-emerald-950/95 backdrop-blur-md border-b border-emerald-800/60 text-white transition-all shadow-md">
      ...
      <div className="hidden lg:block bg-emerald-900/90 text-emerald-100 text-xs py-1.5 px-4 border-b border-emerald-800/40">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-18 flex items-center justify-between">
        ...
        >
          ...
          <div>
            ...
            <p className="hidden sm:block text-xs text-emerald-300 font-medium tracking-wide">
        ...
        <div className="hidden lg:flex items-center gap-3">
          <button
            ...
            className="hidden xl:inline-flex items-center gap-1.5 px-3 py-2 text-xs sm:text-sm font-semibold text-emerald-200 hover:text-white bg-emerald-900/60 hover:bg-emerald-800/80 rounded-lg border border-emerald-700/50 transition-colors"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-emerald-950 font-bold px-4 py-2.5 rounded-lg text-sm sm:text-base shadow-lg shadow-amber-600/30 hover:shadow-amber-500/40 transition-all hover:-translate-y-0.5 active:translate-y-0"
          >
      ...
      {/* Mobile Drawer Menu */}
      {mobileMenuOpen && (
        <div className="lg:hidden bg-emerald-950 border-b border-emerald-800 px-4 pt-3 pb-6 space-y-3 animate-fadeIn">
          ...
          <div className="pt-3 border-t border-emerald-800/80 space-y-2.5">
            <button
              onClick={() => handleNav('/register')}
              className="w-full py-3.5 bg-amber-500 hover:bg-amber-400 text-emerald-950 font-bold rounded-xl text-center text-base shadow-md flex items-center justify-center gap-2"
            >
            ...
            <button
              onClick={() => handleNav('/compensation')}
              className="w-full py-3 bg-emerald-900 hover:bg-emerald-800 text-emerald-100 font-semibold rounded-xl text-center text-sm border border-emerald-700/60 flex items-center justify-center gap-2"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full py-3 bg-emerald-800/60 text-emerald-200 font-medium rounded-xl text-center text-sm flex items-center justify-center gap-2"
            >
