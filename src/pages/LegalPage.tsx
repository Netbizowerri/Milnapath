      ...
      <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-md border border-stone-200/90 space-y-8">
        {type === 'income-disclaimer' && (
          <div className="space-y-6">
            ...
            <div className="prose prose-stone text-xs sm:text-sm leading-relaxed space-y-4 text-stone-700">
              <h3 className="text-base font-bold text-emerald-950">1. Nature of the Direct Selling Business</h3>
              <p>
              ...
              <h3 className="text-base font-bold text-emerald-950">2. Earnings Simulator & Hypothetical Projections</h3>
              <p>
              ...
              <h3 className="text-base font-bold text-emerald-950">3. Dietary Supplement & Health Statement</h3>
              <p>
        ...
        {type === 'terms' && (
          <div className="space-y-6">
            ...
            <div className="prose prose-stone text-xs sm:text-sm leading-relaxed space-y-4 text-stone-700">
              <h3 className="text-base font-bold text-emerald-950">1. Independent Distributor Status</h3>
              <p>
              ...
              <h3 className="text-base font-bold text-emerald-950">2. Ethical Advertising & Claims</h3>
              <p>
              ...
              <h3 className="text-base font-bold text-emerald-950">3. Bank Transfer Verification</h3>
              <p>
        ...
        <div className="pt-6 border-t border-stone-200 flex items-center justify-between">
          ...
          <button
            ...
            className="px-5 py-2.5 bg-emerald-800 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl shadow-sm transition-colors"
          >
