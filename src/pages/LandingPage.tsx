...
Hello Support, I just submitted my Fast Registration on the homepage. I am making payment of ₦${selectedTier.cost.toLocaleString()} to GT Bank (${COMPANY_DETAILS.accountNumber} - ${COMPANY_DETAILS.accountName}). Please confirm and activate my distributor ID.`;
  ...
  return (
    <div className="space-y-16 pb-12">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-purple-950 via-purple-900 to-purple-950 text-white pt-12 pb-20 px-4 sm:px-6 lg:px-8 border-b border-purple-800">
        ...
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            <div className="inline-flex items-center gap-2 bg-purple-800/80 border border-purple-600/50 px-3.5 py-1.5 rounded-full text-xs font-semibold text-purple-200 shadow-inner">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-2">
              <div className="flex items-center gap-2 text-xs sm:text-sm font-medium text-purple-100 bg-purple-900/50 p-3 rounded-xl border border-purple-800/60">
              ...
              <div className="flex items-center gap-2 text-xs sm:text-sm font-medium text-purple-100 bg-purple-900/50 p-3 rounded-xl border border-purple-800/60 col-span-2 sm:col-span-1">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-4">
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-purple-800/80 hover:bg-purple-700 text-purple-100 font-semibold text-sm border border-purple-600/40 transition-all hover:scale-105"
              >
          ...
          <div className="lg:col-span-5">
            <div className="bg-white text-stone-900 rounded-3xl p-6 sm:p-8 shadow-2xl border-4 border-amber-400/40 relative">
              {/* Corner Tag */}
              <div className="absolute -top-3.5 right-6 bg-gradient-to-r from-amber-500 to-amber-600 text-purple-950 font-extrabold text-xs px-3.5 py-1 rounded-full uppercase tracking-wider shadow-md flex items-center gap-1.5">
                <Zap className="w-3.5 h-3.5 fill-purple-950" />
                <span>Fast Partner Registration</span>
              </div>

              <div className="mb-5 text-left">
                <span className="text-xs font-extrabold tracking-wider uppercase text-purple-700 block mb-1">
                  Official Distributor Fast-Track
                </span>
                <h3 className="text-xl sm:text-2xl font-bold font-serif text-purple-950">
              ...
              {registrationSuccess ? (
                <div className="text-left py-2 space-y-4">
                  <div className="text-center space-y-2">
                    ...
                    <h4 className="text-xl font-bold text-purple-950 font-serif">
                      Distributor Spot Reserved!
                    </h4>
                    <p className="text-xs sm:text-sm text-stone-600 max-w-sm mx-auto">
                      Congratulations, <span className="font-bold text-purple-900">{formData.fullName}</span>! Your registration details have been securely captured.
                    </p>
                  </div>
                  ...
                  <div className="bg-stone-50 border border-stone-200 rounded-xl p-3.5 space-y-1.5 text-xs sm:text-sm">
                    <div className="flex justify-between items-center text-stone-600">
                      ...
                      <span className="font-bold text-purple-950">{selectedTier.name} (₦{selectedTier.cost.toLocaleString()})</span>
                    </div>
                    <div className="flex justify-between items-center text-stone-600">
                    ...
                    <div className="flex justify-between items-center text-stone-600">
                      ...
                      <span className="font-semibold text-purple-700">Direct Mentorship Core</span>
                    </div>
                  </div>

                  {/* Official GT Bank Account Information */}
                  <div className="bg-purple-950 text-white rounded-xl p-4 border border-purple-800 space-y-2.5">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[10px] bg-purple-800 text-purple-200 px-2 py-0.5 rounded font-mono">
                        Verified Corporate
                      </span>
                    </div>
                    <div>
                      <span className="text-xs text-purple-300 block">Account Name</span>
                      <p className="text-sm sm:text-base font-bold text-white">{COMPANY_DETAILS.accountName}</p>
                    </div>
                    <div className="bg-purple-900/80 p-2.5 rounded-lg flex items-center justify-between border border-purple-700/60">
                      <div>
                        <span className="text-[11px] text-purple-300 block">Account Number</span>
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 bg-purple-700 hover:bg-purple-600 text-white rounded-md text-xs font-semibold flex items-center gap-1.5 transition-colors cursor-pointer"
                      >
                        {accountCopied ? (
                          <>
                  ...
                  <div className="space-y-2.5 pt-1">
                    <button
                      ...
                      className="w-full py-3.5 bg-purple-600 hover:bg-purple-500 text-white font-bold rounded-xl text-sm shadow-md flex items-center justify-center gap-2 transition-all hover:scale-[1.02] cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="w-full py-2.5 bg-white hover:bg-stone-50 text-purple-900 font-semibold rounded-xl text-xs sm:text-sm border border-stone-300 transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
                    >
                ...
                <form onSubmit={handleFastRegisterSubmit} className="space-y-3.5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 bg-stone-50 border border-stone-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-purple-600 text-stone-900 placeholder:text-stone-400"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3.5 py-2.5 bg-stone-50 border border-stone-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-purple-600 text-stone-900 font-medium"
                    >
                  ...
                  <button
                    ...
                    className="w-full py-3.5 sm:py-4 bg-gradient-to-r from-purple-700 via-purple-600 to-purple-800 hover:from-purple-600 hover:to-purple-700 text-white font-extrabold rounded-xl text-sm sm:text-base shadow-xl shadow-purple-800/30 flex items-center justify-center gap-2 transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-75 cursor-pointer"
                  >
                    {isSubmitting ? (
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8">
        <div className="bg-white rounded-2xl shadow-xl border border-purple-100 p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <h4 className="text-sm font-bold text-purple-950 uppercase tracking-wide">NAFDAC Regulated</h4>
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <h4 className="text-sm font-bold text-purple-950 uppercase tracking-wide">GT Bank Verified</h4>
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <h4 className="text-sm font-bold text-purple-950 uppercase tracking-wide">14% Binary Leverage</h4>
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <h4 className="text-sm font-bold text-purple-950 uppercase tracking-wide">Daily Bank Payouts</h4>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <div className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-purple-700 bg-purple-100/70 px-3 py-1 rounded-full">
            ...
            >
              ...
              <div className="relative h-44 sm:h-48 w-full overflow-hidden bg-stone-50/80 flex items-center justify-center pt-6 pb-2 px-3 border-b border-stone-100">
                ...
                <div className="absolute top-2 left-2 right-2 flex items-center justify-between pointer-events-none gap-1 z-10">
                  <span className="text-[10px] sm:text-[11px] font-semibold tracking-normal px-2 py-0.5 rounded-full bg-purple-950/85 text-purple-200 shadow-xs border border-purple-800/40 backdrop-blur-xs truncate max-w-[70%]">
                    {prod.category}
                  </span>
              ...
              <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between">
                <div>
                  <h3 className="font-serif font-bold text-base sm:text-lg text-stone-900 group-hover:text-purple-700 transition-colors leading-tight">
                    {prod.name}
                  </h3>
                ...
                <div className="pt-4 mt-4 border-t border-stone-100 space-y-2.5">
                  ...
                  <div className="pt-2 grid grid-cols-2 gap-2">
                    ...
                    <a
                      ...
                      className="w-full py-2.5 bg-purple-700 hover:bg-purple-600 text-white text-sm font-bold rounded-lg text-center shadow-xs transition-colors flex items-center justify-center gap-1"
                    >
                      <span>Order</span>
                    </a>
                  </div>
            ...
            <div
              ...
              className={`relative bg-white rounded-3xl p-6 sm:p-7 shadow-lg border transition-all duration-200 flex flex-col justify-between ${
                pkg.id === 'vip'
                  ...
                  : pkg.id === 'executive'
                  ? 'border-purple-400 ring-1 ring-purple-300 shadow-purple-50'
                  : 'border-stone-200'
              }`}
            >
              {/* Badge if any */}
              {pkg.badge && (
                <div className="absolute -top-3 right-6 bg-gradient-to-r from-amber-500 to-amber-600 text-purple-950 text-xs font-extrabold uppercase px-3.5 py-1 rounded-full shadow-sm">
                  {pkg.badge}
                </div>
              )}
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <h3 className="font-serif font-bold text-xl sm:text-2xl text-purple-950">
                    {pkg.name}
                  </h3>
                  <span className="text-xs sm:text-sm font-bold px-3 py-1 rounded-full bg-purple-50 text-purple-800 border border-purple-100">
                    {pkg.pv} PV
                  </span>
                </div>
                ...
                <div className="space-y-3 py-3.5 border-y border-stone-100 text-sm">
                  <div className="flex items-center justify-between text-stone-700">
                    ...
                    <span className="font-bold text-purple-800">{pkg.directBonusRate}% ({pkg.directBonusRange})</span>
                  </div>
                  <div className="flex items-center justify-between text-stone-700">
              ...
              <div className="pt-6">
                <button
                  ...
                  className={`w-full py-3.5 rounded-xl text-sm sm:text-base font-bold shadow-md transition-all flex items-center justify-center gap-2 ${
                    pkg.id === 'vip'
                      ? 'bg-amber-500 hover:bg-amber-400 text-purple-950 shadow-amber-500/20'
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-br from-purple-900 to-purple-950 rounded-3xl p-8 sm:p-12 text-white shadow-2xl relative overflow-hidden border border-purple-800">
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div className="space-y-5 text-left">
              ...
              <div className="pt-4 flex flex-wrap gap-4">
                <button
                  ...
                  className="px-6 py-4 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-purple-950 font-bold text-base shadow-xl shadow-amber-600/30 flex items-center gap-2 transition-all hover:scale-105"
                >
                ...
                <button
                  ...
                  className="px-5 py-3.5 rounded-xl bg-purple-800/80 hover:bg-purple-700 text-purple-100 font-semibold text-sm border border-purple-700 transition-colors"
                >
            ...
            <div className="bg-purple-950/80 p-6 sm:p-8 rounded-2xl border border-purple-700/60 space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-purple-800">
                <span className="text-sm font-bold text-amber-400 uppercase tracking-wider">
                  Guaranty Trust Bank (GT Bank)
                </span>
                <span className="text-xs bg-purple-800 text-purple-200 px-2.5 py-1 rounded font-mono">
                  Verified Corporate
                </span>
              </div>

              <div>
                <span className="text-xs sm:text-sm text-purple-300 block">Account Name</span>
                <p className="text-xl font-bold text-white font-serif">{COMPANY_DETAILS.accountName}</p>
              </div>

              <div className="bg-purple-900/60 p-4 rounded-xl border border-purple-700/80">
                <span className="text-xs sm:text-sm text-purple-400 block mb-1">Corporate Account Number</span>
                <div className="flex items-center justify-between">
              ...
              <button
                onClick={() => navigate('/register')}
                className="w-full py-3.5 bg-purple-600 hover:bg-purple-500 text-white font-bold rounded-xl text-sm sm:text-base transition-colors shadow-sm flex items-center justify-center gap-2"
              >
