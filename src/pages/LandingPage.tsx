...
export const LandingPage: React.FC<LandingPageProps> = ({ navigate, openExitModal }) => {
  ...
  const handleOptInSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await fetch(COMPANY_DETAILS.formspreeEndpoint, {
        ...
        body: JSON.stringify({
          formName: 'Milnapath Hero Opt-In Funnel',
          ...formData,
  ...
  return (
    <div className="space-y-16 pb-12">
      {/* 1. HERO SECTION & LEAD MAGNET OPT-IN */}
        ...
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <p className="text-base sm:text-lg text-emerald-100/90 leading-relaxed font-normal max-w-2xl">
              Unlock true recurring residual income with Nigeria’s fastest-growing botanical health company. Learn how our direct mentorship partners earn through <strong className="text-white">14% binary matching to infinity</strong> and high-demand NAFDAC-approved cellular medicines.
            </p>
            ...
            {/* Direct VSL Action for quick viewers */}
          ...
          {/* Right Column: High-Converting Opt-in Form */}
