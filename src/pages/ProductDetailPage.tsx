    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12">
      ...
      <div className="flex items-center gap-2 text-sm text-stone-500">
        <button
          ...
          className="hover:text-purple-700 font-medium flex items-center gap-1 transition-colors"
        >
        ...
        <span>/</span>
        <span className="text-purple-900 font-bold">{product.name}</span>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-gradient-to-br from-purple-900 to-purple-950 rounded-3xl overflow-hidden text-white shadow-xl border border-purple-700/60 relative flex flex-col justify-between">
            ...
            <div className="p-5 sm:p-6 bg-purple-950/95 border-t border-purple-800/80">
              <h2 className="text-2xl sm:text-3xl font-bold font-serif text-white tracking-tight">
                {product.name}
              </h2>
              <p className="text-sm sm:text-base text-purple-200/95 mt-1 font-medium">
                {product.presentation}
              </p>
            </div>

            {/* Badges footer */}
            <div className="p-4 bg-purple-950/90 border-t border-purple-800/80 flex items-center justify-around text-center text-xs sm:text-sm text-purple-300">
              <div>
                <ShieldCheck className="w-5 h-5 text-purple-400 mx-auto mb-1" />
                <span>NAFDAC Approved</span>
              </div>
              <div className="border-l border-purple-800 h-7"></div>
              <div>
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="space-y-3">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold font-serif text-purple-950">
              {product.name}
            </h1>
          ...
          <div className="bg-purple-50 border border-purple-200 rounded-2xl p-5 space-y-2">
            <h4 className="text-sm font-bold uppercase tracking-wider text-purple-950 flex items-center gap-1.5">
              <Clock className="w-4 h-4 text-purple-700" />
              Recommended Dosage & Administration
            </h4>
            <p className="text-sm sm:text-base text-purple-950 font-medium leading-relaxed">
              {product.dosage}
            </p>
            <p className="text-xs sm:text-sm text-purple-800 italic">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-2xl p-6 sm:p-7 border border-stone-200 shadow-sm space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <h4 className="text-base font-bold uppercase tracking-wider text-purple-950 flex items-center gap-2">
          ...
          <div className="flex flex-wrap gap-2.5">
            {product.activeBotanicals.map((bot, i) => (
              <span
                key={i}
                className="bg-purple-50 text-purple-900 text-sm sm:text-base px-4 py-2 rounded-xl font-medium border border-purple-200"
              >
                🌿 {bot}
              </span>
            ))}
          ...
          <div className="w-full space-y-2">
            <div className="flex items-center justify-between px-1">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 text-xs font-bold text-purple-700 hover:text-purple-900 bg-purple-50 hover:bg-purple-100 px-3 py-1.5 rounded-lg border border-purple-200 transition-colors cursor-pointer"
              >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4 bg-white p-6 sm:p-7 rounded-2xl border border-stone-200 shadow-sm">
          <h3 className="text-base font-bold uppercase tracking-wider text-purple-950 flex items-center gap-2">
          ...
          {otherProducts.map((op) => (
            ...
            >
              ...
              <div className="p-5 flex-1">
                <h4 className="font-bold text-base sm:text-lg text-stone-900 font-serif group-hover:text-purple-700 transition-colors">
                  {op.name}
                </h4>
              ...
              <div className="p-5 pt-3 flex items-center justify-between border-t border-stone-100 bg-stone-50/50">
                ...
                <button
                  ...
                  className="text-sm font-bold text-purple-700 hover:underline cursor-pointer"
                >
                  View Product →
                </button>
              </div>
